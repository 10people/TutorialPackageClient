...
public class RelationButtionWindowLogic : MonoBehaviour 
{
    ...
    public UIImageButton m_PlayerFlower;             // 送花
    public UIImageButton m_PlayerEgg;                // 砸蛋
    ...
    void HideAllUI()
    {
        if (m_LeaderImgBtn.gameObject != null)
        {
            m_LeaderImgBtn.gameObject.SetActive(false);
        }
        if (m_KickImgBtn.gameObject != null)
        {
            m_KickImgBtn.gameObject.SetActive(false);
        }
        if (m_LeaveImgBtn.gameObject != null)
        {
            m_LeaveImgBtn.gameObject.SetActive(false);
        }
        if (m_InviteTeamImgBtn.gameObject != null)
        {
            m_InviteTeamImgBtn.gameObject.SetActive(false);
        }
        if (m_JoinTeamImgBtn.gameObject != null)
        {
            m_JoinTeamImgBtn.gameObject.SetActive(false);
        }
        /*if (m_DismissTeamImgBtn.gameObject != null)
        {
            m_DismissTeamImgBtn.gameObject.SetActive(false);
        }*/
        if (m_FollowTeamImgBtn.gameObject != null)
        {
            m_FollowTeamImgBtn.gameObject.SetActive(false);
        }
        if (m_RelationChatBtn.gameObject != null)
        {
            m_RelationChatBtn.gameObject.SetActive(false);
        }
        if (m_RelationViewBtn.gameObject != null)
        {
            m_RelationViewBtn.gameObject.SetActive(false);
        }
        if (m_RelationTeamBtn.gameObject != null)
        {
            m_RelationTeamBtn.gameObject.SetActive(false);
        }
        if (m_RelationDelBtn.gameObject != null)
        {
            m_RelationDelBtn.gameObject.SetActive(false);
        }
        if (m_AddFriendImgBtn.gameObject != null)
        {
            m_AddFriendImgBtn.gameObject.SetActive(false);
        }
        if (m_BlackDelBtn.gameObject != null)
        {
            m_BlackDelBtn.gameObject.SetActive(false);
        }
        if (m_PlayerTrail.gameObject != null)
        {
            m_PlayerTrail.gameObject.SetActive(false);
        }
        if (m_TrailDel.gameObject != null)
        {
            m_TrailDel.gameObject.SetActive(false);
        }
        if (m_PlayerFlower.gameObject != null)
        {
            m_PlayerFlower.gameObject.SetActive(false);
        }
        if (m_PlayerEgg.gameObject != null)
        {
            m_PlayerEgg.gameObject.SetActive(false);
        }
    }
    ...
    public void UpdateFriendInfo(/*Relation relation*/)
    {
        ...
        {
            m_PlayerFlower.gameObject.SetActive(true);
            m_PlayerEgg.gameObject.SetActive(true);
        }      
