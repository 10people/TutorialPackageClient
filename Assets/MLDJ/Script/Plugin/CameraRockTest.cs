...
public class CameraRockTest : MonoBehaviour
{
	...
	void Start()
    {
        ...
        /*if (GameManager.gameManager.RunningScene == (int)Games.GlobeDefine.GameDefine_Globe.SCENE_DEFINE.SCENE_YUQINGGONG)
        {
            m_PlayerPos = new Vector3(19.6f, 22.47f, 14.7f);
        }
        else if (GameManager.gameManager.RunningScene == (int)Games.GlobeDefine.GameDefine_Globe.SCENE_DEFINE.SCENE_WULIANGSHAN)
        {
            m_PlayerPos = new Vector3(45.5f, 20.0f, 9.07f);
        }
        else if (GameManager.gameManager.RunningScene == (int)Games.GlobeDefine.GameDefine_Globe.SCENE_DEFINE.SCENE_TIANSHAN)
        {
            m_PlayerPos = new Vector3(14.5f, 20.0f, 50.2f);
        }
        else if (GameManager.gameManager.RunningScene == (int)Games.GlobeDefine.GameDefine_Globe.SCENE_DEFINE.SCENE_XINGZILIN)
        {
        ...
        else if (GameManager.gameManager.RunningScene == (int)Games.GlobeDefine.GameDefine_Globe.SCENE_DEFINE.SCENE_XIAOJINGHU)
        {
