...
namespace Games.Events
{
    public class GameEvent
    {
        ...
        public GameEvent(Games.GlobeDefine.GameDefine_Globe.EVENT_DEFINE nEventID)
        {
            Reset();
            m_idEvent = nEventID;
        }

        Games.GlobeDefine.GameDefine_Globe.EVENT_DEFINE m_idEvent;
        public Games.GlobeDefine.GameDefine_Globe.EVENT_DEFINE EventID
        {
        ...
        public void Reset()
        {
            m_idEvent = Games.GlobeDefine.GameDefine_Globe.EVENT_DEFINE.EVENT_INVALID;
