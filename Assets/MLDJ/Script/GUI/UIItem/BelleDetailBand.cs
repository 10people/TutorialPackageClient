...
//     public UILabel labelAttrAddValue;
// 
...
//         if (null != curBelleData)
//         {
//             labelAttrAddValue.color = m_ColorHighlight;
//             CloseAddValue = curBelleData.closeAddValue;
//         }
//         else
//         {
//             labelAttrAddValue.color = m_ColorDisable;
//         }
// 
//         labelAttrAddValue.text = Utils.GetDicByID(1592) + "6: " + Utils.GetAttrTypeString(curTabBelle.CloseAddAttrType) + Utils.GetDicByID(1593) + CloseAddValue; 
// 
//         // 设置情缘显示
