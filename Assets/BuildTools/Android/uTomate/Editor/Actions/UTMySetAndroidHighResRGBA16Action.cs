...
public class UTMySetAndroidHighResRGBA16Action : UTAction
{
	...
	public static void AddAction() {
        Create<UTMySetAndroidHighResRGBA16Action>();
	}
	...
	public	static	bool HandleSetAndroidHighRes(string assetPath)
	{
		...
		if(obj != null)
		{
			...
			if(textureImporter != null)
			{
                ...
                textureImporter.SetPlatformTextureSettings("Android", size, TextureImporterFormat.ARGB16);
