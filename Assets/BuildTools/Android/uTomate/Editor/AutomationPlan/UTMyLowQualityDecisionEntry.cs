...
[Serializable]
[UTDoc(title="Decision", description="Allows androidBase of the automation plan based on a decision.")]
public class UTMyLowQualityDecisionEntry : UTAutomationPlanEntry
{
