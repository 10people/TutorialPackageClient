    ...
    void ShowDefaultWindowMySelf()
    {
        ...
        switch ((GC_HUASHAN_PVP_STATE.HSPVPSTATE)HuaShanPVPData.HuaShanState)
        {
            ...
            case GC_HUASHAN_PVP_STATE.HSPVPSTATE.REGOK:
                strPos = StrDictionary.GetClientDictionaryString("#{1635}", (HuaShanPVPData.HuaShanPosition+1).ToString());
...
#region Useless
    ...
    void AskForJinYaoDaiRank( )
    {
        ...
        //scoreRankPak.NType = (int)Games.GlobeDefine.GameDefine_Globe.RANKTYPE.TYPE_HUASHANJINYAODAI;
        //scoreRankPak.NPage = 0;
        //scoreRankPak.SendPacket();
       // UIManager.ShowUI(UIInfo.RankRoot, SendJinYaoDaiRank);
        RankWindow.ShowRankWindow((int)Games.GlobeDefine.GameDefine_Globe.RANKTYPE.TYPE_HUASHANJINYAODAI);
    }
...
//             RankWindow.Instance().ChangeTabTableau("Tab3");
    ...
    void AskForPosRank()
    {
        ...
        //CG_ASK_RANK scoreRankPak = (CG_ASK_RANK)PacketDistributed.CreatePacket(MessageID.PACKET_CG_ASK_RANK);
        //scoreRankPak.NType = (int)Games.GlobeDefine.GameDefine_Globe.RANKTYPE.TYPE_HUASHANPOS;
        //scoreRankPak.NPage = 0;
        //scoreRankPak.SendPacket();

        RankWindow.ShowRankWindow((int)Games.GlobeDefine.GameDefine_Globe.RANKTYPE.TYPE_HUASHANPOS);
    }
