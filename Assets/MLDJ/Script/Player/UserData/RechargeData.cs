...
//        }
    ...
    {
        GoodInfo textGood;
        textGood = new GoodInfo();
        textGood.goods_describe = "250元宝";
        textGood.goods_icon = "jinbi";
        textGood.goods_id = "0";
        textGood.goods_name = "招财进宝";
        textGood.goods_number = "1";
        textGood.goods_price = "250";
        textGood.goods_register_id = "com.cyou.mrd.cabal.item0";
        m_dicGoodInfos.Add(textGood.goods_register_id, textGood);
        ...
        textGood.goods_name = "招财进宝";
        textGood.goods_number = "1";
        textGood.goods_price = "6";
        textGood.goods_register_id = "com.cyou.mrd.cabal.item1";
        m_dicGoodInfos.Add(textGood.goods_register_id, textGood);
        ...
        textGood.goods_name = "招财进宝";
        textGood.goods_number = "1";
        textGood.goods_price = "30";
        textGood.goods_register_id = "com.cyou.mrd.cabal.item2";
        m_dicGoodInfos.Add(textGood.goods_register_id, textGood);
        ...
        textGood.goods_name = "招财进宝";
        textGood.goods_number = "1";
        textGood.goods_price = "60";
        textGood.goods_register_id = "com.cyou.mrd.cabal.item3";
        m_dicGoodInfos.Add(textGood.goods_register_id, textGood);
        ...
        textGood.goods_name = "招财进宝";
        textGood.goods_number = "1";
        textGood.goods_price = "198";
        textGood.goods_register_id = "com.cyou.mrd.cabal.item4";
        m_dicGoodInfos.Add(textGood.goods_register_id, textGood);
        ...
        textGood.goods_name = "招财进宝";
        textGood.goods_number = "1";
        textGood.goods_price = "388";
        textGood.goods_register_id = "com.cyou.mrd.cabal.item5";
        m_dicGoodInfos.Add(textGood.goods_register_id, textGood);
        ...
        textGood.goods_name = "招财进宝";
        textGood.goods_number = "1";
        textGood.goods_price = "648";
        textGood.goods_register_id = "com.cyou.mrd.cabal.item6";
        m_dicGoodInfos.Add(textGood.goods_register_id, textGood);
        ...
        textGood.goods_name = "招财进宝";
        textGood.goods_number = "1";
        textGood.goods_price = "1648";
        textGood.goods_register_id = "com.cyou.mrd.cabal.item7";
        m_dicGoodInfos.Add(textGood.goods_register_id, textGood);
        ...
        textGood.goods_name = "招财进宝";
        textGood.goods_number = "1";
        textGood.goods_price = "6498";
        textGood.goods_register_id = "com.cyou.mrd.cabal.item8";
        m_dicGoodInfos.Add(textGood.goods_register_id, textGood);
        ...
        //textGood.goods_name = "招财进宝";
        //textGood.goods_number = "1";
        //textGood.goods_price = "6490";
        //textGood.goods_register_id = "com.cyou.mrd.cabal.item9";
        //m_dicGoodInfos.Add(textGood.goods_register_id, textGood);
    }
}
