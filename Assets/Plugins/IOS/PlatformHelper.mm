...
extern "C" int _getUpdateChannelAppConfig()
{
    return UPDATE_CHANNELAPP_CONFIG_VERSION;
}
...
extern "C" void _SGSetRecognizeEnable(bool enable)
{
    [SDKHelper SGSetRecognizeEnable:enable];
}
...
extern "C" const void _setH5CustomServiceData(const char *serverName, 
                                              const char *serverID, 
                                              const char *roleName, 
                                              const char *roleID, 
...
{
    [SDKHelper SetH5CustomServiceData:
        [NSString stringWithUTF8String:serverName] :
        [NSString stringWithUTF8String:serverID] :
        [NSString stringWithUTF8String:roleName] :
        [NSString stringWithUTF8String:roleID] :
        [NSString stringWithUTF8String:roleLevel] :
        [NSString stringWithUTF8String:vipLevel] :
        [NSString stringWithUTF8String:gameVersion]];
}

extern "C" const void _shareToFBWithImage(const char *url, const char *text)
{
    
}

extern "C" const void _ShowOverlapActivity(const char* url)
{
    [SDKHelper ShowOverlapActivity:[NSString stringWithUTF8String:url]];
}

extern "C" const void _ShowPolicy()
{
    [SDKHelper ShowPolicy];
}

extern "C" const bool _IsGuest()
{
    return [SDKHelper IsGuest];
}

extern "C" const void _guestBind()
{
    [SDKHelper GuestBind];
}

extern "C" const char *_getCDNOrgUrl()
{
    return MakeStringCopy(CDN_ORG_URL);
}

extern "C" const char *_getCDNReplaceUrl()
{
    return MakeStringCopy(CDN_REPLACE_URL);
}

extern "C" const char *_getCDNReplaceUrl2()
{
    return MakeStringCopy(CDN2_REPLACE_URL);
}

extern "C" const void _instanceADYSDKWithProjectID(const char* projectID)
{
    [SDKHelper InstanceADYSDKWithProjectID:[NSString stringWithUTF8String:projectID]];
}

extern "C" const void _setADYParamWithKey(const char* key, const char* value)
{
    [SDKHelper SetADYParamWithKey:[NSString stringWithUTF8String:key ]:[NSString stringWithUTF8String:value ]];
}

extern "C" const void _launchCYMGADYH5Page()
{
    [SDKHelper LaunchCYMGADYH5Page];
}