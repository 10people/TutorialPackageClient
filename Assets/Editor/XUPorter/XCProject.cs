...
namespace UnityEditor.XCodeEditor
{
	public partial class XCProject : System.IDisposable
	{
		...
		#region PBXMOD
		public bool AddOtherLinkFlags(string flag)
		{
			return AddOtherLinkFlags (new PBXList (flag));
		}
		...
		public bool AddOtherLinkFlags(PBXList flags)
		{
			...
			{
				buildConfig.Value.AddOtherLinkFlags(flags);
			}
			modified = true;
			return modified;
		}

		public bool EnableObjCException(string flag)
		{
			return EnableObjCException (new PBXList (flag));		
		}
		...
		public bool EnableObjCException(PBXList flags)
		{
			foreach(KeyValuePair<string, XCBuildConfiguration> buildConfig in buildConfigurations)
			{
				buildConfig.Value.EnableObjCException(flags);
			}
			modified = true;
			return modified;	
		}
		...
		{	
			...
			Debug.Log ("Adding linkerflags...");
			AddOtherLinkFlags(mod.linkerflags);

			Debug.Log ("Adding EnableObjcException...");
			EnableObjCException (mod.objcexception);
