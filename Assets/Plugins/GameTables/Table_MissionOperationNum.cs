...
public class Tab_MissionOperationNum
{ private const string TAB_FILE_DATA = "Tables/MissionOperationNum.txt";
 enum _ID
 {
 INVLAID_INDEX=-1,
ID_ID,
...
private int m_OperationType;
 public int OperationType { get{ return m_OperationType;}}
