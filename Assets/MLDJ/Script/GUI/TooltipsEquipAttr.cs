...
public class TooltipsEquipAttr : MonoBehaviour {
 ...
 //   public UIGrid m_Grid;
  //  public UITopGrid m_TopGrid;
    ...
    public GameObject[] m_ShenQiAttrWhole;
    public UILabel[] m_ShenQiAttrName;
    public UILabel[] m_ShenQiAttrValue;
    public GameObject m_ShenQiSkillName;
    public UILabel    m_ShenQiSkillNameLable;
    public GameObject m_ShenQiSkillDesc;
    public UILabel    m_ShenQiSkillDescLable;
    //public UILabel[] m_StarAttr;
    public GameObject m_ShenQiSkillCutLine;
    public GameObject[] m_ShenQiAttrCutLine;
    public void ClearInfo()
    {
        ...
        for (int i = 0; i < m_ShenQiAttrWhole.Length; ++i)
        {
            m_ShenQiAttrValue[i].text = "";
            m_ShenQiAttrValue[i].text = "";
            m_ShenQiAttrWhole[i].SetActive(false);
            m_ShenQiAttrCutLine[i].SetActive(false);
        }
        m_ShenQiSkillNameLable.text = "";
        m_ShenQiSkillName.SetActive(false);
        m_ShenQiSkillDescLable.text = "";
        m_ShenQiSkillDesc.SetActive(false);
        m_ShenQiSkillCutLine.SetActive(false);
    }
