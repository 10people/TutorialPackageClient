...
public class RestaurantFoodItem : MonoBehaviour {
    ...
    public GameObject m_MakeBtn;

    private Color m_GrayColor = new Color(116.0f / 255.0f, 95.0f / 255.0f, 230.0f / 255.0f, 1.0f);
    private Color m_GrayRewardColor = new Color(184.0f / 255.0f, 184.0f / 255.0f, 184.0f / 255.0f, 1.0f);

    private Color m_NormalColor = new Color(230.0f / 255.0f, 213.0f / 255.0f, 95.0f / 255.0f, 1.0f);
