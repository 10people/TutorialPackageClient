...
public class RestaurantDesk : MonoBehaviour {
	...
	public GameObject EmptyFoodDestBk;
    public GameObject PreFoodDestBk;
	public GameObject eatingFoodDestBk;
    ...
    public void UpdateDestInfo()
    {
		...
		if (null == EmptyFoodDestBk)
		{
			LogModule.ErrorLog("EmptyFoodDestBk is null");
			return;
		}   
                ...
                case RestaurantData.DeskState.PrepareFood:
                    {
						...
						m_LabelStateDetail.text = m_curDestData.GetLeftTime();
						EmptyFoodDestBk.SetActive(false);
                        PreFoodDestBk.SetActive(true);
						eatingFoodDestBk.SetActive(false);
                ...
                case RestaurantData.DeskState.EatFood:
                    {
						...
						eatingFoodDestBk.SetActive(true);
...
//                            int curGuestId = m_curDestData.m_GuestIDs[i];
                ...
                default:
                    {
						...
						EmptyFoodDestBk.SetActive(true);
                        PreFoodDestBk.SetActive(false);
						eatingFoodDestBk.SetActive(false);
                        EatFoodDestBk.SetActive(false);
                        for (int i = 0; i < m_GuestWindows.Length; i++)
    ...
    void OnDeskClick()
    {
        if (RestaurantController.Instance().NewPlayerGuide_Step == 4 && this.gameObject.name == "Desk00")
        {
            RestaurantController.Instance().NewPlayerGuide(5);
        }
    ...
    {
        return (m_curDestData != null && m_curDestData.m_IsActive && m_curDestData.m_DestState == RestaurantData.DeskState.None);
    }
}
