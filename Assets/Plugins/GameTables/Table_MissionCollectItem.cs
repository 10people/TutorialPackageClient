...
public class Tab_MissionCollectItem
{ private const string TAB_FILE_DATA = "Tables/MissionCollectItem.txt";
 enum _ID
 {
 INVLAID_INDEX=-1,
ID_ID,
...
public static bool LoadTable(Dictionary<int, List<object> > _tab)
 ...
 Tab_MissionCollectItem _values = new Tab_MissionCollectItem();
