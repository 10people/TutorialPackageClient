...
public class GuildChangeDeclarationWindowLogic : MonoBehaviour {
    ...
    {
        m_NoticeInput.value = "";
        m_NoticeInput.defaultText = StrDictionary.GetClientDictionaryString("#{10454}");
    }
    ...
    void OnChangeOKClick()
    {
        ...
        Singleton<ObjManager>.GetInstance().MainPlayer.ReqChangeGuildDeclaration(szNoticeContent);
