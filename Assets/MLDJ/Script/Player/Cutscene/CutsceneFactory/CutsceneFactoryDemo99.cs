...
namespace Cutscene
{
    public class CutsceneFactoryDemo99: CutsceneFactoryBase
    {
        #region Fields
        #endregion
        ...
        public override Cutscene CreatCutscene()
        {
			...
			DefineAction ("CameraMove1", new CutsceneActionCameraTarget (1136,1),true);
			...
			DefineAction ("DuiHua1", new CutsceneActionStoryDialog (298),true);
			DefineAction ("DuiHua2", new CutsceneActionStoryDialog (296),true);
