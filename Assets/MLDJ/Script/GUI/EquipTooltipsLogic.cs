...
public class EquipTooltipsLogic : MonoBehaviour
{
    ...
    public UILabel m_EquipLevelTitleLabel;
    ...
    public BoxCollider m_EquipDescBoxCollider;
    ...
    void ShowEquipStrengthenLevel(GameItem equip)
    {
        if (equip != null && equip.IsValid())
        {
            ...
            m_EquipStrengthenLevelLabel.text = "+" + nStrengthenLevel;
    ...
    void ShowEquipDesc(GameItem equip)
    {
        if (equip != null && equip.IsValid())
        {
            ...
            if (null != tabItem)
            {
                ...
                strEquipDesc = strEquipDesc.Replace("#r", "\n");
                m_EquipDescLabel.text += strEquipDesc;
                m_EquipDescBoxCollider.size = new Vector3(m_EquipDescLabel.width, m_EquipDescLabel.printedSize.y, 0);
                m_EquipDescBoxCollider.center = new Vector3(0.5f * m_EquipDescBoxCollider.size.x, -0.5f * m_EquipDescBoxCollider.size.y, 0);
            }
        }
    }
    ...
    void ShowEquipPrice(GameItem equip)
    {
        if (equip != null && equip.IsValid())
        {
            ...
            if (tabItem != null)
            {
                ...
                {
                    m_EquipPriceIcon.spriteName = "qian5";
                }
    ...
    {
#if UNITY_WP8
        BuyItemOpenConsignSale(true, null);
