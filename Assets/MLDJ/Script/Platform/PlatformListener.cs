...
public class PlatformListener : MonoBehaviour {
    ...
    private void WpLoginReconnect(bool bSuccess, string strResult)
    {
        if (bSuccess)
        {
            SendLoginInfo();
	...
	public void OnCYSwitchAccount(string param)
	{
		GlobeVar.isShowSwitchAccountButton = false;
	}
