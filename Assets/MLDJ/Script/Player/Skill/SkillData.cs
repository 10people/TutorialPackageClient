...
namespace Games.SkillModle
{
    ...
    public struct OwnSkillData
    {
        ...
        private int m_nLevelUpExp;
        public int LevelUpExp
        {
            get { return m_nLevelUpExp; }
            set { m_nLevelUpExp = value; }
        }
        public void CleanUp()
        {
            m_nSkillId = -1;
    ...
    public  struct MultiShowDamageBoard //多次显示 
    {
        public void CleanUp()
        {
            ...
            m_nShowTimes = -1;
            m_fShowInter = -1.0f;
            m_nDamageType = Games.GlobeDefine.GameDefine_Globe.DAMAGEBOARD_TYPE.PLAYER_TYPE_INVALID;
            m_fLastShowTime = 0;
        }
        ...
        private Games.GlobeDefine.GameDefine_Globe.DAMAGEBOARD_TYPE m_nDamageType;
        public Games.GlobeDefine.GameDefine_Globe.DAMAGEBOARD_TYPE DamageType
        {
