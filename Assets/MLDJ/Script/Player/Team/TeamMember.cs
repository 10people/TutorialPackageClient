...
public class TeamMember
{
    ...
    public void CleanUp()
    {
        ...
        m_nModelVisualId = GlobeVar.INVALID_ID;
        m_nWeaponDataId = GlobeVar.INVALID_ID;
        m_nWeaponEffectGem = GlobeVar.INVALID_ID;
        TeamCJGTier = GlobeVar.INVALID_ID;
    }
	...
	private int m_nLevel;               //在线状态（0离线 1在线）
	public int Level
	{
		get { return m_nLevel; }
		set { m_nLevel = value; }
	...
	private int m_nOnLineState;               //队员等级
	public int OnLineState
    {
		get { return m_nOnLineState; }
		set { m_nOnLineState = value; }
    }
    ...
    private int m_nModelVisualId;
    public int ModelVisualId
    {
        get { return m_nModelVisualId; }
        set { m_nModelVisualId = value; }
    }

    private int m_nWeaponDataId;
    public int WeaponDataId
    {
        get { return m_nWeaponDataId; }
        set { m_nWeaponDataId = value; }
    }

    private int m_nWeaponEffectGem;
    public int WeaponEffectGem
    {
        get { return m_nWeaponEffectGem; }
        set { m_nWeaponEffectGem = value; }
    }

    private int m_nTeamCJGTier;             //多人藏经阁记录层数
    public int TeamCJGTier
    {
        get { return m_nTeamCJGTier; }
        set { m_nTeamCJGTier = value; }
    }
}
