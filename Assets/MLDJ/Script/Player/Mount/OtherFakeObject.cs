...
namespace Games.FakeObject
{
    public class OtherFakeObject
    {
        ...
        private void LoadOtherViewWapon(GameObject Obj, string szBindPt, string szResPath, Vector3 weaponRotation)
        {
            if (null == Obj)
                return;
            ...
            param.Add(null);
            param.Add(GameManager.gameManager.OtherPlayerData.Profession);
            param.Add(GameManager.gameManager.OtherPlayerData.CurWeaponDataID);
            param.Add(weaponRotation);
