...
public struct PayActivityData 
{
    ...
    /// </summary>
    /// <returns></returns>
    public bool IsDayCardFlag()
    {
        return m_Flags[(int)FLAGTYPE.FLAG_DAYCARD];
    }
    ...
    public float GetYBPrizeRate()
    {
        ...
        //老服返利
        if (m_OldServerRate > 0.0f)
        {
            result += m_OldServerRate;
        }
        return result;
    }
    ...
    //成长基金等级限制
    private int m_GrowUpLevel;
    public int GrowUpLevel
    {
        get { return m_GrowUpLevel; }
        set { m_GrowUpLevel = value; }
    }
    //日卡开关
    private bool m_bDayCardOpen;
    public bool DayCardOpen
    {
        get { return m_bDayCardOpen; }
        set { m_bDayCardOpen = value; }
    }
