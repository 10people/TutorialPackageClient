    ...
    void OnLoadQualityItem(GameObject resObj, object param)
    {
        ...
        if (null != _gameObject)
        {
            ...
            if (null != QualityItem)
            {
                ...
                //先屏蔽掉红色
                //QualityItem = null;
                //_gameObject = Utils.BindObjToParent(resObj, m_GridObj, "06red");
                //if (null != _gameObject)
                //{
                //    QualityItem = _gameObject.GetComponent<ConsignSaleQualityItem>();
                //}
                //if (null != QualityItem)
                //{
                //    QualityItem.SetLableName(StrDictionary.GetClientDictionaryString("#{5471}"));
                //    QualityItem.SetQuality((int)ItemQuality.QUALITY_RED);
                //}
            }
        }
