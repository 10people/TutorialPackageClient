...
/// 任务主视图
/// </summary>
public class MissionView_Main : MonoBehaviour 
{
#region UI ref
...
#region functions
    ...
    void AddListeners()
    {
        UIEventListener.Get(btnAbandon).onClick = AbandonMission;
    }
    ...
    void SetData(int missionId)
    {
        ...
        btnAbandon.SetActive(mission.MissionType != (int)MISSIONTYPE.MISSION_MAIN);
