...
public class BaseAttr
{
    ...
    public int RoleBaseID
    {
        ...
        set
        {
            if (m_nRoleBaseID != value)
            {
                m_CachedRoleBase = null;
            }
            m_nRoleBaseID = value;
        }
    }
    ...
    private Tab_RoleBaseAttr m_CachedRoleBase = null;
    public Tab_RoleBaseAttr CachedRoleBase
    {
        get
        {
            if (m_CachedRoleBase == null)
            {
                m_CachedRoleBase = TableManager.GetRoleBaseAttrByID(m_nRoleBaseID,0);
            }
            return m_CachedRoleBase;
        }
    }
}
