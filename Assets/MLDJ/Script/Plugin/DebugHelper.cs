...
public class DebugHelper : MonoBehaviour {
    ...
    public static void CreateDebugHelper()
    {
        ...
        {
            // 日志处理
            helperInstance.AddComponent<UnityGuiConsole>();
        }
    }
    ...
    private bool m_bOpenHideUI = false;
    private bool m_bOpenPlayerSound = false;
    private bool m_bOpenNameHeight = false;
    private bool m_bOpenUnload = false;
