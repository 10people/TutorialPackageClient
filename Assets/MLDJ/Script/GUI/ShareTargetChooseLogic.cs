...
public class ShareTargetChooseLogic : MonoBehaviour {
    ...
    private static bool m_bIsYaoHe = false;
    public static bool IsYaoHe
    {
    ...
    public static void InitEquipShare(GameItem item,string additionShareMsg ="",bool IsYaoHe=false)
    {
    ...
    public static void InitItemShare(GameItem item, string additionShareMsg ="",bool bIsYaoHe=false)
    {
        m_additionShareMsg =additionShareMsg;
        m_bIsYaoHe = bIsYaoHe;
