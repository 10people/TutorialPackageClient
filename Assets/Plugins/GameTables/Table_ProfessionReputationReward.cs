...
public class Tab_ProfessionReputationReward
{ private const string TAB_FILE_DATA = "Tables/ProfessionReputationReward.txt";
 enum _ID
 {
 INVLAID_INDEX=-1,
ID_INDEX,
...
public static bool LoadTable(Dictionary<int, List<object> > _tab)
 ...
 Tab_ProfessionReputationReward _values = new Tab_ProfessionReputationReward();
