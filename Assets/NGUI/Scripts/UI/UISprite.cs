...
public class UISprite : UIWidget
{
    ...
    public delegate void OnPostFillCallback(UIWidget widget, BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols);
	...
	public override void OnFill (BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
        ...
        if (onPostFill != null)
            onPostFill(this, verts, uvs, cols);
	}

    public override WidgetType GetWidgetType() { return UIWidget.WidgetType.WT_Sprite; }
