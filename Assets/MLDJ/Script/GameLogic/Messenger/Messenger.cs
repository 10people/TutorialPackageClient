/********************************************************************************
 *	文件名：	GameManager.cs
 *	全路径：	\Script\GameLogic\Messenger\Messenger.cs
 *	创建人：	陈惟楚
 *	创建时间：2015-03-21
 *
 *	功能说明：消息订阅系统，使用观察者模式降低各模块间耦合度
 *	修改记录：
*********************************************************************************/
...
//		private static MessengerHelper messengerHelper = ( new GameObject("MessengerHelper") ).AddComponent< MessengerHelper >();
	...
	public static readonly List<string> permanentMessages = new List<string> ();
	#endregion
	...
	public class BroadcastException : ApplicationException 
	{
		public BroadcastException(string msg) : base(msg) {}
	}
		
	public class ListenerException : ApplicationException 
	{
	...
	{
		Broadcast(eventType, MessengerMode.DONT_REQUIRE_LISTENER);
	}
	...
	{
		Broadcast<T>(eventType, arg1, MessengerMode.DONT_REQUIRE_LISTENER);
	}

	public static void Broadcast<T>(string eventType, T arg1, MessengerMode mode) 
	{
		#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
		Debug.Log("MESSENGER\t" + System.DateTime.Now.ToString("hh:mm:ss.fff") + "\t\t\tInvoking \t\"" + eventType + "\"");
		#endif
	...
	{
		Broadcast<T, U>(eventType, arg1, arg2, MessengerMode.DONT_REQUIRE_LISTENER);
	}

	public static void Broadcast<T, U>(string eventType, T arg1, U arg2, MessengerMode mode) 
	{
		#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
		Debug.Log("MESSENGER\t" + System.DateTime.Now.ToString("hh:mm:ss.fff") + "\t\t\tInvoking \t\"" + eventType + "\"");
		#endif
	...
	{
		Broadcast<T, U, V>(eventType, arg1, arg2, arg3, MessengerMode.DONT_REQUIRE_LISTENER);
	}

	public static void Broadcast<T, U, V>(string eventType, T arg1, U arg2, V arg3, MessengerMode mode) 
	{
		#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
		Debug.Log("MESSENGER\t" + System.DateTime.Now.ToString("hh:mm:ss.fff") + "\t\t\tInvoking \t\"" + eventType + "\"");
		#endif
