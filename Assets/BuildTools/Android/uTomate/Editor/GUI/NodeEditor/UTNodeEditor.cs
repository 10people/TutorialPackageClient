...
public class UTNodeEditor
{
	...
	private static void AddMyDecisionNode (object userData)
	{
		var data = (NodeEventData)userData;
		data.model.AddEntry<UTMyAutomationPlanDecisionEntry> (data.evt.mousePosition);
	}

	private static void AddLowQualityDecisionNode (object userData)
	{
		var data = (NodeEventData)userData;
		data.model.AddEntry<UTMyLowQualityDecisionEntry> (data.evt.mousePosition);
	}

    private static void AddMyCopyAssetBundlesDecisionNode(object userData)
    {
        var data = (NodeEventData)userData;
        data.model.AddEntry<UTMyAutomationPlanAssetBundlesDecisionEntry>(data.evt.mousePosition);
    }
    ...
    private static void AddMyForEachForBuildNode(object userData)
    {
        var data = (NodeEventData)userData;
        data.model.AddEntry<UTMyForEachForBuildEntry>(data.evt.mousePosition);
    }
